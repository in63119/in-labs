...
export default function AdminWeb3AuthPanel() {
  ...
  return (
    <div className="space-y-4 rounded-xl border border-[color:var(--color-border-strong)] bg-[color:var(--color-charcoal)] p-6">
      ...
      <label className="flex flex-col gap-2 text-sm">
        <input
          ...
          className="rounded-lg border border-[color:var(--color-border-strong)] bg-[color:var(--color-charcoal-plus)] px-4 py-2 text-[color:var(--color-ink)] outline-none"
        />
      </label>
    </div>
  );
